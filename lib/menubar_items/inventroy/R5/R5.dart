...
import 'package:application/menubar_items/inventroy/R5/r5add.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class r5 extends StatefulWidget {
  @override
  State<r5> createState() => r5State();
}

class r5State extends State<r5> {
  @override
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => R5add()),
                            );
                          },
