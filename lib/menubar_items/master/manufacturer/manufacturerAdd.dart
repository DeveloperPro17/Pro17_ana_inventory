...
class manufactureradd extends StatefulWidget {
  const manufactureradd({super.key});

  @override
  State<manufactureradd> createState() => _manufactureraddState();
}

class _manufactureraddState extends State<manufactureradd> {
  @override
                    ...
                    children: [
                      Container(
                        ...
                        child: const Padding(
                          ...
                          child: Text(
                            ' Inventory / Manufacturer / Add Manufacturer',
